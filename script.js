PetiteVue.createApp({
  ...
  quizList: [
    ...
    // 1問目
    {
      statement: 'あなたの身近な女性は月経時どのような状態だと思いますか？ （ あなたは月経時どのような状態ですか？ ）  　最も顕著に出ていると思う症状を選択してください', // クイズの文章
      options: [
    ...
    // 2問目
    {
      statement: 'あなたの身近な女性は月経時の症状に変化を感じていると思いますか？ （ あなたは月経時の症状に変化がありますか？ ）　 最も当てはまるものを選択してください',
      options: [
    ...
    // 3問目
    {
      statement: 'あなたの身近な女性の月経痛の強さはどの程度だとおもいますか？ （ あなたの月経痛の強さはどの程度ですか？ ）  最も当てはまるものを選択してください',
      options: [
    ...
    {
      statement:
        'あなたの身近な女性は月経時に月経痛以外の症状があると思いますか？ （ あなたは月経時に月経痛以外の症状はありますか？ ）  最も顕著に出ていると思う症状を選択してください',
      options: [
        '腹部の膨満感を感じている',
        '嘔吐、吐き気がある',
        '貧血気味になっている',
    ...
    {
      statement:
        'あなたの身近な女性は月経時や月経時以外にどのような症状があると思いますか？ （ あなたは月経時や月経時以外にどのような症状がありますか？ ）  最も顕著に出ていると思う症状を選択してください',
      options: [
        '痛み止めを飲まないと体を動かせない',
        '月経時以外にも痛みが起こっている',
    ...
    // 6問目
    {
      statement: 'あなたの身近な女性は月経時や月経時以外にどのような症状があると思いますか？ （ あなたは月経時や月経時以外にどのような症状がありますか？ ）  最も顕著に出ていると思う症状を選択してください',
      options: ['だるく疲れた気持ちになっている', '腰の痛みを感じている', 'お手洗いに行く回数が増えている', '特に何もないように思う(わからない)'],
      types: [[0], [2], [2], [2]]
    },
    // 7問目
    {
      statement: 'あなたの身近な女性は月経時に出かける際、普段との変化があるように思いますか？ （ あなたは月経時に出かける際、普段との変化がありますか？ ）',
      options: [
    ...
    {
      statement:
        'あなたの身近な女性は月経が始まる３～10日前ごろから普段との変化があるように思いますか？ （ あなたは月経が始まる３～10日前ごろから普段との変化がありますか？ ）  最も顕著に出ていると思う症状を選択してください',
      options: [
        'イライラしている',
        '憂鬱になっている',
        '胸が張り、痛みを感じている',
    ...
    {
      statement:
        'あなたの身近な女性は月経が始まる３～10日前ごろから困っていることがあると思いますか？ （ あなたは月経が始まる３～10日前ごろから困っていることはありますか？ ）  最も当てはまるものを選択してください',
      options: [
        '集中力が低下してしまうこと',
        '興味や意欲が減退してしまうこと',
        '眠気に襲われてしまうこと',
    ...
    {
      statement:
        'あなたの身近な女性は月経が始まる３～10日前ごろから悩んでいることがあると思いますか？ （ あなたは月経が始まる３～10日前ごろから悩んでいることはありますか？ ）  最も当てはまるものを選択してください',
      options: [
        '食べ過ぎてしまう(過食)',
    ...
    {
      statement:
        'あなたの身近な女性が月経前3～10日前ごろから身体的・精神的不快症状が現れること(PMS)により、社会的な行動(仕事や人間関係など)にどのような変化があると思いますか？ （ あなたは月経前3～10日前ごろから身体的・精神的不快症状が現れること(PMS)により、社会的な行動(仕事や人間関係など)にどのような変化があると感じていますか？ ）',
      options: [
    ...
    // 12問目
    {
      statement: 'あなたの身近な女性がPMSを最も感じている期間はいつだと思いますか？ （ あなたがPMSを最も感じている期間はいつですか？ ）',
    ...
    {
      statement:
        'あなたの身近な女性が仮にPMSの症状を月経10日前から感じている場合、1か月の中でPMSでも月経でもない期間は何日ほどだと思いますか？ （ あなたが仮にPMSの症状を月経10日前から感じている場合、1か月の中でPMSでも月経でもない期間は何日ほどだと思いますか？ ）',
      options: ['約20日', '約15日', '約10日', '約5日'],
      types: [[2], [2], [2], [2]]
    },
    // 14問目
    {
      statement: 'あなた(のパートナー)がPMSの影響が最も出ていると感じている場面はどこだと思いますか？ （ あなたがPMSの影響が最も出ていると感じている場面はどこですか？ ）',
      options: ['仕事(学校)において', '家事において', '影響は感じていないと思う', 'わからない'],
      types: [[2], [2], [4], [4]]
    },
    // 15問目
    {
      statement: 'あなた(のパートナー)がPMSの影響が最も出ていると感じている場面はどこだと思いますか？ （ あなたがPMSの影響が最も出ていると感じている場面はどこですか？ ）',
      options: ['恋人やパートナーとの関係において', '人間関係において', '影響は感じていないと思う', 'わからない'],
      types: [[2], [2], [4], [4]]
    },
    ...
    // 22問目
    {
      statement: 'あなたの身近な女性が月経中に出来ていないと思っていることは何だと考えますか？ （ あなたが月経中に出来ていないと思っていることは何ですか？ ）',
      options: [
        '生理が重いときは周囲の人に気軽に頼る',
        '生理中であってもいつも通りふるまう',
