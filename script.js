PetiteVue.createApp({
  ...
  quizList: [
    ...
    {
      statement:
        'あなた(のパートナー)は月経時に月経痛以外の症状はありますか？最も顕著に出ていると思う症状を選択してください。',
      options: [
        '腹部の膨満感を感じている',
        '嘔吐、吐き気がある',
        '貧血気味になっている',
    ...
    {
      statement:
        'あなた(のパートナー)は月経時や月経時以外にどのような症状がありますか？最も顕著に出ていると思う症状を選択してください。',
      options: [
        '痛み止めを飲まないと体を動かせない',
        '月経時以外にも痛みが起こっている',
    ...
    {
      statement:
        'あなた(のパートナー)は月経が始まる3～10日前ごろから普段との変化がありますか？最も顕著に出ていると思う症状を選択してください',
      options: [
        'イライラしている',
        '憂鬱になっている',
        '胸の張りを気にしている',
    ...
    {
      statement:
        'あなた(のパートナー)は月経が始まる3～10日前ごろから困っていることはありますか？最も当てはまるものを選択してください',
      options: [
        '集中力が低下してしまうこと',
        '興味や意欲が減退してしまうこと',
        '眠気に襲われてしまうこと',
    ...
    {
      statement:
        'あなた(のパートナー)は月経が始まる3～10日前ごろから悩んでいることはありますか？最も当てはまるものを選択してください',
      options: [
        '食べ過ぎてしまう(過食)',
    ...
    {
      statement:
        'あなた(のパートナー)が月経前3～10日前ごろから身体的・精神的不快症状が現れること(PMS)により、社会的な行動(仕事や人間関係など)にどのような変化があると思いますか？',
      options: [
    ...
    // 11問目
    {
      ...
      options: [
        'とても思う',
        '人によって症状の程度が異なると思うため、女性同士でも理解に差があると思う',
        'わからない',
        '人とは話しづらい内容のように思う'
      ],
      types: [[1, 2], [2], [1], [0]]
    ...
    {
      statement:
        'あなた(のパートナー)が仮にPMSの症状を月経10日前から感じている場合、1か月の中でPMSでも月経でもない期間は何日ほどだと思いますか？',
    ...
    {
      statement:
        'あなたのパートナーは月経中どのようなことに悩んでいると思いますか？(あなたは月経中どのようなことに悩んでいますか？)最も当てはまると思うものを選択してください',
    ...
    {
      statement:
        'あなたのパートナーが月経中に嫌だと感じることは何だと思いますか？(あなたが月経中に嫌だと感じることは何ですか？)最も当てはまると思うものを選択してください',
      options: [
    ...
    {
      statement:
        'あなたのパートナーが月経中うまくいかないと感じていることは何だと思いますか？(あなたが月経中うまくいかないと感じていることは何ですか？)最も当てはまると思うものを選択してください',
      options: [
    ...
    {
      statement:
        'あなたのパートナーが月経中に出来ていないと思っていることは何だと考えますか？(あなたが月経中に出来ていないと思っていることは何ですか？)最も当てはまると思うものを選択してください',
      options: [
        '月経中でも普段通りに過ごす',
    ...
    {
      statement:
        'あなたのパートナーが月経中に出来ていないと思っていることは何だと考えますか？(あなたが月経中に出来ていないと思っていることは何ですか？)',
      options: [
        '月経が重い日に仕事(学校)を休む',
  ...
  judgmentList: [
    // 判定結果 0
    {
      statement: 'あなた（のパートナー）は正常な月経でしょう',
      links: [
        {
          title: '桃太郎のための食事計画',
